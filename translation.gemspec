Gem::Specification.new do |s|
  ...
  s.description      = 'Localize your app using either t(".keys") or _("plain text") and type "rake translation:sync" to synchronize with your translators on Translation.io.'
