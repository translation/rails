...
describe Translation::Client::SyncOperation::CreateYamlPoFilesStep do
  it do
...
EOS
    ...
    step_operation = Translation::Client::SyncOperation::CreateYamlPoFilesStep.new(source_locale, yaml_file_paths)
    params = {}
