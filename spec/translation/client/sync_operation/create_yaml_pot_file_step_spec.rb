...
describe Translation::Client::SyncOperation::CreateYamlPotFileStep do
  it do
...
EOS
    ...
    step_operation = Translation::Client::SyncOperation::CreateYamlPotFileStep.new(source_locale, yaml_file_paths)
    params = {}
