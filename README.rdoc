= gem for [http://rails.translation.io](Rails Translation)

== Description

Add this gem to your [http://rubyonrails.org](Rails) app to translate it with [http://rails.translation.io](Rails Translation).
...
Inititalize your translation project :
