 ...
 * Add `rake translation:sync_and_show_purgeable` task to see all unused keys/strings from Translation.io, using the current branch as reference ([#20](https://github.com/aurels/translation-gem/issues/20)).
 * Better file formats configuration in configuration file ([#14](https://github.com/aurels/translation-gem/pull/14)).
 * Better wording
...
## [v1.9](https://github.com/aurels/translation-gem/releases/tag/v1.9) (2017-02-16)
...
## [v1.8.4](https://github.com/aurels/translation-gem/releases/tag/v1.8.4) (2016-12-02)

#### Fixes (bugs & defects):

 * Debug FlatHash.to_hash in a very specific case. This issue should not happen in consistent YAML files.

## [v1.8.3](https://github.com/aurels/translation-gem/releases/tag/v1.8.3) (2016-09-06)

#### Fixes (bugs & defects):

 * Don't set LC_TYPE to avoid warnings on Linux ([#7](https://github.com/aurels/translation-gem/pull/7))

## [v1.8.2](https://github.com/aurels/translation-gem/releases/tag/v1.8.2) (2016-07-20)

#### Fixes (bugs & defects):

 * Add missing wee and wen locales to Locale (Upper Sorbian and Lower Sorbian)

## [v1.8.1](https://github.com/aurels/translation-gem/releases/tag/v1.8.1) (2016-07-08)

#### Fixes (bugs & defects):

 * Removed clutter (lost puts)

## [v1.8](https://github.com/aurels/translation-gem/releases/tag/v1.8) (2016-07-06)

#### New features:

 * When `disable_gettext` is set to `true`, only load GetText libraries where needed to consume less memory.

## [v1.7](https://github.com/aurels/translation-gem/releases/tag/v1.7) (2016-04-19)
...
## [v1.6](https://github.com/aurels/translation-gem/releases/tag/v1.6) (2016-02-03)

#### Fixes (bugs & defects):

 * Debug check of source locale during init.

## [v1.5](https://github.com/aurels/translation-gem/releases/tag/v1.5) (2016-01-08)
...
## [v1.4](https://github.com/aurels/translation-gem/releases/tag/v1.4) (2015-12-11)
...
## [v1.3](https://github.com/aurels/translation-gem/releases/tag/v1.3) (2015-11-13)
...
## [v1.2](https://github.com/aurels/translation-gem/releases/tag/v1.2) (2015-07-03)

#### New features:

 * Ensure the correct locale can be set only for the current thread.

## [v1.1.3](https://github.com/aurels/translation-gem/releases/tag/v1.1.3) (2015-03-31)

#### New features:

 * Ensure GetText.locale is in sync with I18n's default locale at boot

## [v1.1.2](https://github.com/aurels/translation-gem/releases/tag/v1.1.2) (2015-03-18)
...
## [v1.1.0](https://github.com/aurels/translation-gem/releases/tag/v1.1.0) (2015-03-17)
...
## [v1.0.1](https://github.com/aurels/translation-gem/releases/tag/v1.0.1) (2015-01-08)

#### Fixes (bugs & defects):

 * Development dependencies resolution in gemspec.

## [v1.0.0](https://github.com/aurels/translation-gem/releases/tag/v1.0.0) (2015-01-08)
...
## [v0.9.7](https://github.com/aurels/translation-gem/releases/tag/v0.9.7) (2014-12-12)
...
## [v0.9.5](https://github.com/aurels/translation-gem/releases/tag/v0.9.5) (2014-10-10)
...
## [v0.9.4](https://github.com/aurels/translation-gem/releases/tag/v0.9.4) (2014-09-26)
...
## [v0.9.3](https://github.com/aurels/translation-gem/releases/tag/v0.9.3) (2014-09-11)

#### Fixes (bugs & defects):

 * Fix issue when there is absolutely no YAML keys on the init (happens when not-english source language)

## [v0.9.2](https://github.com/aurels/translation-gem/releases/tag/v0.9.2) (2014-09-09)

#### Fixes (bugs & defects):

 * Does not break on empty YAML files loading

## [v0.9.1](https://github.com/aurels/translation-gem/releases/tag/v0.9.1) (2014-09-05)

#### New features:

 * Better management of reserved keys in YAML (no, n, true, false, etc.)

## [v0.9](https://github.com/aurels/translation-gem/releases/tag/v0.9) (2014-09-05)
